...
CREATE TABLE `endpoints` (
  ...
  `http_method` enum('GET','POST','PUT','DELETE','PATCH') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`endpoint_id`),
  KEY `component_id` (`component_id`),
  CONSTRAINT `endpoints_ibfk_1` FOREIGN KEY (`component_id`) REFERENCES `components` (`component_id`)
